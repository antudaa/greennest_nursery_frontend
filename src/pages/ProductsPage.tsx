...
const ProductsPage = () => {
    ...
    return (
        <div className="min-h-screen lg:mx-20 mx-4 my-10">
            <h1 className="text-[#524434] text-3xl md:text-4xl font-semibold animate-fade-in whitespace-nowrap my-10">
                View Our All Products Here🌴
            </h1>
            ...
            <div className="my-20 lg:mx-20 mx-4">
                ...
                <div className="">
                    <div className="flex flex-wrap gap-4 justify-center mx-auto">
                        {products?.filter((product) => !product?.isDeleted)?.map((product: TProduct) => {
                            return (
